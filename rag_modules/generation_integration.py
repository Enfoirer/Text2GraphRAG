...
class GenerationIntegrationModule:
    ...
    def __init__(self, model_name: str = "gpt-4o-mini", temperature: float = 0.1, max_tokens: int = 2048):
        """
        初始化生成集成模块
        """
    ...
    def generate_adaptive_answer(self, question: str, documents: List[Document]) -> str:
        ...
        请提供准确、循证的回答。根据问题的性质：
        - 若询问疾病概述，请说明病因、症状、风险与预防
        - 若询问治疗或用药，请描述主要方案、适用人群与注意事项
        - 若询问护理建议，请结合生活方式与随访提示
