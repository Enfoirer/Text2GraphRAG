...
class MilvusIndexConstructionModule:
    ...
    def _format_tags(self, value: Any) -> str:
        """将标签字段统一为字符串"""
        if value is None:
            return ""
        ...
        try:
            ...
            for i, (chunk, vector) in enumerate(zip(chunks, vectors)):
                entity = {
                    ...
                    "severity": self._safe_truncate(chunk.metadata.get("severity", ""), 50),
                    "tags": self._safe_truncate(self._format_tags(chunk.metadata.get("tags")), 500),
        ...
        try:
            ...
            search_kwargs = {
                ...
                "output_fields": ["text", "node_id", "entity_name", "node_type", 
                                "category", "severity", "tags", "doc_type",
                                "chunk_id", "parent_id"],
