...
class IntelligentQueryRouter:
    ...
    def analyze_query(self, query: str) -> QueryAnalysis:
        ...
        1. 查询复杂度 (0-1)：
           - 0.0-0.3: 简单信息查找（如：干眼症有哪些症状？）
           - 0.4-0.7: 中等复杂度（如：青光眼手术后的护理要点？）
           - 0.8-1.0: 高复杂度推理（如：糖尿病视网膜病变与青光眼的关系？）
        
        2. 关系密集度 (0-1)：
           - 0.0-0.3: 单一实体信息（如：白内障的手术方式）
           - 0.4-0.7: 实体间关系（如：干眼症与隐形眼镜佩戴的关系？）
           - 0.8-1.0: 复杂关系网络（如：糖尿病、视网膜病变与黄斑水肿的关联？）
    ...
    def _rule_based_analysis(self, query: str) -> QueryAnalysis:
        ...
        relation_keywords = ["并发", "合并", "关联", "相关", "联系", "引起"]
